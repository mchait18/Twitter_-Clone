...
class UserViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.u3 = User.signup("hig", "test3@test.com", "password", None)
    ...
    def test_users_index(self):
         with self.client as c:                       
            ...
            self.assertIn("@hig", str(resp.data))
    ...
    def test_users_search(self):
        with self.client as c:                       
            ...
            self.assertNotIn("@hig", str(resp.data))
    ...
    def test_add_like(self):     
        m1 = Message(id=9876, text="trending warble", user_id=self.u1_id)
        db.session.add(m1)
        db.session.commit()       
